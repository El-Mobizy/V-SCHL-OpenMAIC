  ...
  if (notes.length === 0) {
    return (
      <div className="h-full flex flex-col items-center justify-center text-center p-6">
        <div className="w-12 h-12 bg-cyan-50 dark:bg-cyan-900/20 rounded-2xl flex items-center justify-center mb-3 text-cyan-300 dark:text-cyan-600 ring-1 ring-cyan-100 dark:ring-cyan-800/30">
        ...
        return (
          <div
            ...
            className={cn(
              ...
              isCurrent
                ? 'bg-primary/5 dark:bg-primary/10 ring-1 ring-primary/20 dark:ring-primary/30'
            ...
            <div className="flex items-center gap-2 mb-1.5">
              ...
              <div
                className={cn(
                  ...
                  isCurrent
                    ? 'bg-primary dark:bg-primary shadow-sm shadow-primary/40'
              ...
              {isCurrent && (
                <span className="text-[9px] font-bold px-1.5 py-px rounded-full bg-primary/10 dark:bg-primary/20 text-primary dark:text-primary/80">
