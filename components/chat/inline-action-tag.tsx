...
const WB_STYLE =
  'bg-cyan-50 dark:bg-cyan-500/15 border-cyan-300/40 dark:border-cyan-500/30 text-cyan-600 dark:text-cyan-300';
const WB_ACCENT = 'bg-cyan-500 dark:bg-cyan-400';
  ...
  return (
    ...
    >
      ...
      {isWb && (
        ...
        >
          <PenLine className="w-[7px] h-[7px] text-white dark:text-cyan-950" strokeWidth={2.5} />
        </span>
      )}
