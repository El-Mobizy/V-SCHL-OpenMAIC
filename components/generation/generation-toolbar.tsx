...
export function GenerationToolbar({
  ...
  const pillActive = `${pillCls} border-primary/60 dark:border-primary/50 bg-primary/10 dark:bg-primary/10 text-primary dark:text-primary`;
        ...
        <PopoverTrigger asChild>
          {pdfFile ? (
            <button className={pillActive}>
              ...
              <span
                role="button"
                className="size-4 rounded-full inline-flex items-center justify-center hover:bg-cyan-200 dark:hover:bg-cyan-800 transition-colors"
                onClick={(e) => {
                  e.stopPropagation();
            ...
            {pdfFile ? (
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  <div className="size-8 rounded-lg bg-cyan-100 dark:bg-cyan-900/30 flex items-center justify-center shrink-0">
              ...
              <div
                className={cn(
                  ...
                  isDragging
                    ...
                    : 'border-muted-foreground/20 hover:border-cyan-300',
                )}
          ...
          <PopoverContent align="start" className="w-64 p-3 space-y-3">
            ...
            >
              <Globe2
                className={cn(
                  'size-4 shrink-0',
                  webSearch ? 'text-primary dark:text-primary' : 'text-muted-foreground',
                )}
              />
          ...
          <PopoverTrigger asChild>
            <button
              className={cn(
                ...
                currentModelId &&
                  'ring-primary/40 dark:ring-primary/40 bg-primary/10 dark:bg-primary/10',
              )}
            >
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    isActive ? 'bg-primary/10 dark:bg-primary/10' : 'hover:bg-muted/50',
                  )}
                >
                  {provider.icon ? (
                    <img
            ...
            {activeProvider.models.map((model) => {
              ...
              return (
                ...
                >
                  ...
                  {isSelected && (
                    <Check className="size-3.5 shrink-0 text-primary dark:text-primary" />
                  )}
                </button>
              );
            })}
