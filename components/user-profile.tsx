...
export function UserProfileCard() {
  ...
  if (!hydrated) {
    return (
      <Card className="p-5 !gap-0 border-muted/40 backdrop-blur-xl bg-card/80">
  ...
  return (
    <Card className="p-5 !gap-0 border-muted/40 backdrop-blur-xl bg-card/80">
      ...
      <div className="flex items-center gap-3.5">
        ...
        >
          <div className="size-11 rounded-full bg-gray-50 dark:bg-gray-800 overflow-hidden ring-2 ring-primary/30 dark:ring-primary/40 group-hover/avatar:ring-primary/50 dark:group-hover/avatar:ring-primary/60 transition-all">
          ...
          {editingName ? (
            <div className="flex items-center gap-1.5">
              <input
                ...
                className="flex-1 min-w-0 h-7 bg-transparent border-b-2 border-primary dark:border-primary text-sm font-semibold text-foreground outline-none placeholder:text-muted-foreground/40"
              />
              <button
                onClick={commitName}
                className="shrink-0 size-6 rounded-md flex items-center justify-center text-primary hover:bg-primary/10 dark:hover:bg-primary/20 transition-colors"
              >
              ...
              {AVATAR_OPTIONS.map((url) => (
                <button
                  ...
                  className={cn(
                    ...
                    avatar === url
                      ? 'ring-2 ring-primary dark:ring-primary ring-offset-1 ring-offset-white dark:ring-offset-background'
              ...
              <label
                ...
                className={cn(
                  ...
                  isCustomAvatar(avatar)
                    ? 'ring-2 ring-primary dark:ring-primary ring-offset-1 ring-offset-white dark:ring-offset-background border-primary dark:border-primary bg-primary/5 dark:bg-primary/20'
