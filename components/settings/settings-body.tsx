...
export function SettingsBody({ initialSection, onClose }: SettingsBodyProps) {
  const { t } = useI18n();
  ...
  return (
    <>
      <div className="flex h-full overflow-hidden">
        ...
        {isAdmin && activeSection === 'providers' && (
          <>
            <ProviderList
        ...
        {isAdmin && activeSection === 'web-search' && (
          <>
            <ProviderListColumn
