      ...
      <div className="flex gap-1.5 items-center py-1.5 px-1">
        <span
          className={cn(
            ...
            isTeacher
              ? 'bg-cyan-400/70 dark:bg-cyan-500/70'
  ...
  return (
    <div
      className={cn(
        ...
        isUser
          ? 'bg-gradient-to-br from-primary to-primary/80 dark:from-primary dark:to-primary/80 text-white rounded-tr-sm shadow-sm shadow-primary/30 dark:shadow-primary/50 ring-1 ring-primary/20'
          : isTeacher
          ...
          return (
            <motion.div
              ...
              className={cn(
                ...
                isActiveBubble &&
                  'border-l-cyan-500 dark:border-l-cyan-400 bg-cyan-50/50 dark:bg-cyan-900/20',
              )}
            >
              {/* Mini Avatar */}
