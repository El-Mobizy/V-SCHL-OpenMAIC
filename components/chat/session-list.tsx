...
const sessionBadgeStyles = {
  ...
  lecture: 'bg-teal-100 text-teal-700 dark:bg-teal-900/30 dark:text-teal-300',
};
        ...
        return (
          <div
            ...
            className={cn(
              ...
              isActive
                ? 'border-primary/30 dark:border-primary/40 bg-primary/5 dark:bg-primary/10 shadow-sm'
