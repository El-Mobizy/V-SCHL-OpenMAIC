    ...
    <div className="flex items-center gap-1.5 shrink-0">
      ...
      {agentMode === 'auto' ? (
        <>
          ...
          <Shuffle className="size-4 text-cyan-400 dark:text-cyan-500" />
        </>
      ) : (
        <>
              ...
              {agentMode === 'preset' ? (
                ...
                <div className="flex flex-col items-center pt-6 pb-3 gap-4">
                  <div className="relative flex items-center justify-center">
                    <div className="absolute size-10 rounded-full bg-cyan-400/10 dark:bg-cyan-400/15 animate-ping [animation-duration:3s]" />
                    <div className="absolute size-12 rounded-full bg-cyan-400/5 dark:bg-cyan-400/10 animate-pulse [animation-duration:2.5s]" />
                    <Shuffle className="relative size-5 text-cyan-400 dark:text-cyan-500" />
                  </div>
