              ...
              >
                ...
                >
                  <motion.div
                    ...
                    className="w-20 h-20 rounded-full bg-white/95 dark:bg-gray-800/95 flex items-center justify-center shadow-[0_4px_30px_rgba(0,138,153,0.25),inset_0_0_0_1px_rgba(0,138,153,0.15)] dark:shadow-[0_4px_30px_rgba(0,178,194,0.35),inset_0_0_0_1px_rgba(0,178,194,0.2)]"
