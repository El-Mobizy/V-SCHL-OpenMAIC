                  ...
                  return (
                    ...
                    >
                      ...
                      <button
                        ...
                        disabled={isClearing}
                        className="ml-2 px-2 py-1 text-xs text-primary dark:text-primary hover:bg-primary/5 dark:hover:bg-primary/10 rounded-md opacity-0 group-hover:opacity-100 transition-opacity flex items-center gap-1 disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:bg-transparent"
                      >
