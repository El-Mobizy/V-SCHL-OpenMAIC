      ...
      <TooltipTrigger asChild>
        <button
          ...
          className={cn(
            ...
            sizeClasses,
            active
              ? 'bg-primary/90 dark:bg-primary/80 text-primary-foreground shadow-[0_0_12px_rgba(0,138,153,0.45)] dark:shadow-[0_0_12px_rgba(0,178,194,0.35)]'
        ...
        >
          ...
          {isRecording && (
            <span
              className="absolute inset-[-4px] rounded-[10px] border border-primary/40 dark:border-primary/30"
              style={{
