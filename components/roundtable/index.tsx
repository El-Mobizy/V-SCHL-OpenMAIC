                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      isSendCooldown
                        ...
                        : 'bg-primary hover:bg-primary/90 shadow-[0_4px_16px_rgba(6,182,212,0.3)]',
                    )}
                  >
                    {isSendCooldown ? (
              ...
              >
                <div className="flex items-center gap-4 bg-white/70 dark:bg-black/60 backdrop-blur-xl rounded-full px-5 py-3 shadow-[0_8px_32px_rgba(0,0,0,0.08)] dark:shadow-[0_8px_32px_rgba(0,0,0,0.4)] border border-gray-200/60 dark:border-white/10">
                  ...
                  <div className="flex items-center gap-0.5 h-8">
                    <VoiceWaveformBars barClassName="bg-gradient-to-t from-cyan-400 to-indigo-400" />
                  </div>
                  <span className="text-[11px] font-semibold tracking-wider text-cyan-600 dark:text-cyan-300 uppercase">
                  ...
                  >
                    <div className="relative w-12 h-12 rounded-full bg-gradient-to-br from-cyan-600 to-indigo-700 shadow-[0_4px_20px_rgba(6,182,212,0.3)] flex items-center justify-center group-hover:scale-105 transition-transform duration-300 border border-white/20">
                      <Mic className="w-5 h-5 text-white" />
                    </div>
                    <div className="absolute inset-0 rounded-full border-2 border-cyan-500 opacity-40 animate-[ping_2s_ease-in-out_infinite]" />
                  </button>
                </div>
              </motion.div>
            )}
                      ...
                      <div className="flex items-center gap-[3px]">
                        {[0, 1, 2].map((i) => (
                          <motion.div
                            ...
                            className="w-[3px] h-[3px] rounded-full bg-cyan-400"
                          />
                        ))}
                      </div>
                    </div>
                        ...
                        className={cn(
                          ...
                          isCueUser
                            ...
                            : activeRole === 'user' || isInputOpen
                              ? 'border-primary shadow-[0_0_6px_rgba(6,182,212,0.3)]'
                              : 'border-gray-300/40 dark:border-white/20 group-hover:border-primary/50',
                        )}
                      />
                      <div className="w-8 h-8 rounded-full bg-gray-200 dark:bg-gray-800 overflow-hidden relative z-10 text-lg">
    ...
    >
      ...
      <div className="flex-1 flex items-stretch min-h-0">
        ...
        >
          ...
          <div className="absolute top-0 inset-x-0 h-16 bg-gradient-to-b from-cyan-50/50 dark:from-cyan-900/10 to-transparent pointer-events-none" />
          <div className="absolute top-3 inset-x-0 flex flex-col items-center justify-center gap-1 opacity-10 pointer-events-none">
            <BookOpen size={20} className="text-cyan-900 dark:text-cyan-100" />
            <div className="w-8 h-0.5 bg-cyan-900 dark:bg-cyan-100 rounded-full" />
          </div>
                    ...
                    >
                      <div
                        className={cn(
                          ...
                          activeRole === 'teacher'
                            ? 'border-primary dark:border-primary shadow-[0_0_12px_rgba(6,182,212,0.4)]'
                            : 'border-gray-200 dark:border-gray-700 group-hover:border-primary/50 dark:group-hover:border-primary/60',
                        )}
                      />
                    ...
                    <span
                      className={cn(
                        ...
                        activeRole === 'teacher' && !speakingStudent
                          ? 'text-primary dark:text-primary border-primary/30 dark:border-primary/60'
                          : 'text-gray-400 dark:text-gray-500 border-gray-100 dark:border-gray-700 group-hover:text-primary/70 dark:group-hover:text-primary/80 group-hover:border-primary/20 dark:group-hover:border-primary/40',
                      )}
                    >
                      {teacherName}
                    </span>
          ...
          >
            ...
            <AnimatePresence>
              {isInputOpen && (
                ...
                >
                  <div className="relative w-fit max-w-[85%] sm:max-w-[65%] min-w-[200px] sm:min-w-[300px] bg-white/90 dark:bg-gray-800/90 backdrop-blur-md p-2 pr-2 rounded-2xl rounded-br-none shadow-2xl border border-primary/30 dark:border-primary/60 flex items-end gap-2 ring-1 ring-primary/10 dark:ring-primary/15">
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        isSendCooldown
                          ...
                          : 'bg-primary hover:bg-primary/90 dark:bg-primary dark:hover:bg-primary/90 shadow-md',
                      )}
                    >
                      {isSendCooldown ? (
              ...
              {isVoiceOpen && (
                ...
                >
                  <div className="flex flex-col-reverse items-end gap-1 mr-[-10px] relative z-20">
                    <div className="flex items-center gap-0.5 h-8 px-2 py-1.5 bg-white/80 dark:bg-gray-800/80 backdrop-blur-md rounded-xl border border-cyan-100 dark:border-cyan-800 shadow-sm">
                      <VoiceWaveformBars barClassName="bg-gradient-to-t from-cyan-500 to-indigo-600 dark:from-cyan-400 dark:to-indigo-500" />
                    </div>
                    <motion.div
                      initial={{ opacity: 0, x: 10 }}
                      animate={{ opacity: 1, x: 0 }}
                      className="text-[10px] font-bold tracking-widest text-cyan-600 dark:text-cyan-400 uppercase bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm px-2 py-0.5 rounded-full shadow-sm border border-cyan-100/50 dark:border-cyan-800/50 mr-1"
                    >
                      {isProcessing ? t('roundtable.processing') : t('roundtable.listening')}
                    </motion.div>
                  </div>
                  ...
                  <div
                    ...
                    onClick={handleToggleVoice}
                  >
                    <div className="relative w-16 h-16 rounded-full bg-gradient-to-br from-cyan-600 to-indigo-700 dark:from-cyan-500 dark:to-indigo-600 shadow-[0_4px_20px_rgba(6,182,212,0.3)] flex items-center justify-center z-20 group-hover:scale-105 transition-transform duration-300 border border-white/20 dark:border-white/10">
                      <Mic className="w-6 h-6 text-white" />
                    </div>
                    <div className="absolute inset-0 rounded-full border-2 border-cyan-500 dark:border-cyan-400 opacity-40 animate-[ping_2s_ease-in-out_infinite] z-10" />
                    ...
                    <div className="absolute inset-0 bg-cyan-600 dark:bg-cyan-500 blur-2xl opacity-20 group-hover:opacity-40 transition-opacity z-0" />
                  </div>
                </motion.div>
              )}
            </AnimatePresence>
                    ...
                    <div
                      className={cn(
                        ...
                        asrEnabled
                          ...
                          : 'bg-cyan-400/[0.08] dark:bg-cyan-500/[0.06]',
                      )}
                    />
                    ...
                    <motion.div
                      ...
                      className={cn(
                        ...
                        asrEnabled
                          ...
                          : 'border-cyan-400/50 dark:border-cyan-500/35',
                      )}
                    />
                    {/* Expanding ripple 2 */}
                    <motion.div
                      ...
                      className={cn(
                        ...
                        asrEnabled
                          ...
                          : 'border-cyan-300/40 dark:border-cyan-400/25',
                      )}
                    />
                    ...
                    <motion.button
                      ...
                      className={cn(
                        ...
                        asrEnabled
                          ...
                          : 'from-cyan-400 to-indigo-500 dark:from-cyan-500 dark:to-indigo-600 shadow-cyan-400/30 dark:shadow-cyan-600/20 hover:shadow-cyan-400/40 dark:hover:shadow-cyan-600/30',
                      )}
                    >
                      {asrEnabled ? (
                    ...
                    <div className="flex items-center justify-center gap-[3px] h-3">
                      {[0, 1, 2, 3, 2, 1, 0].map((intensity, i) => (
                        <motion.div
                          ...
                          className="w-[2.5px] h-full origin-center rounded-full bg-cyan-400/60 dark:bg-cyan-500/50"
                        />
                      ))}
                    </div>
                  )}
                  ...
                  >
                    <div
                      ...
                      className={cn(
                        ...
                        bubbleRole === 'user'
                          ? 'bg-primary/95 dark:bg-primary/95 backdrop-blur-sm border-primary/40 dark:border-primary/40 text-primary-foreground rounded-br-sm shadow-md'
                          : bubbleRole === 'agent'
                            ? cn(
                    ...
                    >
                      ...
                      {bubbleRole !== 'user' &&
                        ...
                        (() => {
                          ...
                          const barsColor =
                            bubbleRole === 'agent' ? 'bg-blue-500' : 'bg-cyan-500';

                          if (btnState === 'none') return null;

                          if (btnState === 'play') {
                            return (
                              <div className="absolute right-2.5 bottom-2.5 p-1.5 rounded-full bg-gray-50/80 dark:bg-gray-700/80 hover:bg-primary/10 dark:hover:bg-primary/15 group-hover/bubble:bg-primary/10 dark:group-hover/bubble:bg-primary/15 transition-all duration-300 cursor-pointer">
                          ...
                          // btnState === 'bars'
                          return (
                            <div className="absolute right-2.5 bottom-2.5 p-1.5 rounded-full bg-gray-50/80 dark:bg-gray-700/80 group-hover/bubble:bg-cyan-100 dark:group-hover/bubble:bg-cyan-900/50 transition-all duration-300">
                              {isDiscussionPaused ? (
                                /* Paused: static Play icon */
                                <Play className="w-3.5 h-3.5 text-amber-500 dark:text-amber-400 group-hover/bubble:text-cyan-600 dark:group-hover/bubble:text-cyan-400 ml-0.5" />
                              ) : (
                                <>
                          ...
                          >
                            <div
                              className={cn(
                                'absolute inset-0 rounded-full border-2 transition-all duration-300',
                                isSpeaking
                                  ? 'border-primary dark:border-primary shadow-[0_0_8px_rgba(6,182,212,0.4)]'
                            ...
                            {isThinkingAgent && (
                              <div className="absolute inset-0 rounded-full border-2 border-cyan-400 border-t-transparent animate-spin z-20" />
                            )}
                          </div>
                        </HoverCardTrigger>
                        <HoverCardContent
                  ...
                  <div className="flex items-center gap-[3px]">
                    {[0, 1, 2].map((i) => (
                      <motion.div
                        ...
                        className="w-[4px] h-[4px] rounded-full bg-cyan-400 dark:bg-cyan-400"
                      />
                    ))}
                  </div>
                </div>
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      !asrEnabled
                        ...
                        : isVoiceOpen
                          ? 'bg-primary dark:bg-primary border-primary dark:border-primary text-primary-foreground shadow-md'
                          : 'bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 text-gray-400 dark:text-gray-500 hover:bg-primary/10 dark:hover:bg-primary/15 hover:text-primary dark:hover:text-primary hover:border-primary/30 dark:hover:border-primary/60',
                    )}
                  >
                    {asrEnabled ? (
                ...
                <div
                  className={cn(
                    ...
                    isCueUser
                      ...
                      : activeRole === 'user' || isInputOpen
                        ? 'border-primary dark:border-primary shadow-[0_0_8px_rgba(6,182,212,0.3)]'
                        : 'border-white dark:border-gray-700 group-hover:border-primary/30 dark:group-hover:border-primary/60',
                  )}
                />
